...
Deploy the contents of `dist/` to any static host with HTTPS. The service worker scope is `/`. The factory registers and switches the Sociobot product environment; no payment-provider credentials belong in this repository.
