...
- `sf-practice-next-card-social.png`: original 1200 × 630 social preview generated from the same prompt sheet. The wide composition keeps quiet paper space on the left and groups the cassette, exactly three blank slips, pencil, and stopwatch on the right. Prompt: `Use case: stylized-concept. Asset type: 1200 by 630 social preview for Practice Next Card. A blank cream audio cassette beside exactly three text-free paper practice slips, a sharpened pencil and a small analog stopwatch on a scarred rehearsal table. Cassette-era independent music zine collage, xerox halftone grain, torn paper fibers, matte ink and masking tape; warm directional desk lamp; wide overhead editorial framing with the objects grouped on the right and calm negative space on the left; oatmeal, charcoal, oxide red and faded cyan palette. No readable text, no musical notation, no logos, no brands, no hands or people, no watermark, no gradients, no glossy 3D, no interface.` Generated with the factory Azure image deployment (`factory-image`) on 2026-09-06. The untouched source and prompt sidecar are in `assets/src/`; the reviewed, cropped PNG is shipped in `public/assets/`. Visual review found no text artifacts, logos, people, notation, seams, or unintended symbols.
